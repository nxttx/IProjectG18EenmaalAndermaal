                ...
                <div class="card-content">
                    ...
                    <form action="" onsubmit="login(this)" method="post" id="form">
                        <div class="field">
                            ...
                            <input class="input is-primary is-large" type="text" name="username" id="Gebruikersnaam"
                                   autofocus="" required placeholder="Gebruikersnaam">
                        </div>
                        <br>
                        <div class="field">
                            <label class="label" for="wachtwoord">Wachtwoord</label>
                            <input class="input is-primary is-large" type="password" name="password" id="wachtwoord"
